...
def segment(polygon: List[Tuple[float, float]], cell_size: float = CELL_SIZE, rotate:float = 0) -> List[List[Tuple[float, float] | str]]:
    """
...
def rotate_point(point: Tuple[float, float], theta: float, p_of_r: Tuple[float, float]) -> Tuple[float, float]:
    """
...
def rotate_shape(shape: List[Tuple[float, float]], theta: float, p_of_r: Tuple[float, float]) -> List[Tuple[float, float]]:
    """
