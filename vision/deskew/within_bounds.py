...
def on_line(point1: list[float], point2: list[float], point3: list[float]) -> bool:
    """
...
def inside_bounds(boundary: list[list[float]], location_point: list[float]) -> bool:
    """
    ...
    ppt_return: float = cv2.pointPolygonTest(
        new_np_boundary, (location_point[0], location_point[1]), False
    )
